    ...
    <div className="flex flex-col w-full bg-white text-gray-900">
      ...
      <section className="relative flex items-center justify-center h-[60vh] w-full bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700">
        <div className="text-center text-white px-4 md:px-0 max-w-3xl">
          ...
          <motion.div
            ...
            className="mt-8"
          >
            {/* Capital Group’s explainer video */}
            <Link
              href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/resources/etf-tax-efficiency-explained.html"
              target="_blank"
            >
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <Card className="shadow-xl rounded-2xl">
            <CardContent className="p-6 md:p-8 space-y-4">
              ...
              <p>
                Reality — turnover influences distributions, but vehicle structure matters
                more. Many active ETFs distribute <strong>80 % fewer gains</strong> than
                comparable active mutual funds.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-xl rounded-2xl">
            <CardContent className="p-6 md:p-8 space-y-4">
              ...
              <p>
                Reality — studies show ETFs, active <em>and</em> passive, delivered the
                highest after‑tax returns versus mutual funds and SMAs across most asset
                classes.
              </p>
            </CardContent>
          </Card>
      ...
      <section className="py-16 px-4 md:px-12 bg-gray-50">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {[
            ...
            <Card key={typeof item === "string" ? item : (item as any).key} className="shadow-xl rounded-2xl">
      ...
      <section className="py-20 px-4 md:px-12 bg-purple-700 text-white text-center">
        ...
        <motion.div
          ...
          className="mt-10"
        >
          {/* Capital Group’s tax‑efficiency resource page */}
          <Link
            href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/resources/tax-efficiency.html"
            target="_blank"
          >
            <Button
              size="lg"
