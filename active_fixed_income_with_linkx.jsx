    ...
    <div className="flex flex-col w-full bg-white text-gray-900">
      ...
      <section className="relative flex items-center justify-center h-[60vh] w-full bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700">
        <div className="text-center text-white px-4 md:px-0 max-w-3xl">
          ...
          >
            Discover how Capital Group’s{" "}
            <a
              href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/details/cgcb"
              target="_blank"
            ...
            ,{" "}
            <a
              href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/details/cgcp"
              target="_blank"
              rel="noopener noreferrer"
              className="underline font-semibold"
            >
            ...
            and{" "}
            <a
              href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/details/cgmu"
              target="_blank"
              rel="noopener noreferrer"
              className="underline font-semibold"
            >
            ...
            harness in‑kind mechanics and active research to pursue higher
            after‑tax returns, tighter spreads and real‑time flexibility.
          </motion.p>
          ...
          <motion.div
            ...
            className="mt-8"
          >
            <Link href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/active-fixed-income-etfs.html" target="_blank">
      ...
      <section className="py-16 px-4 md:px-12 bg-gray-50">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
          What Makes Active Fixed‑Income ETFs <span className="text-indigo-600">Different</span>
        </h2>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <Card className="shadow-xl rounded-2xl">
            <CardContent className="p-6 md:p-8 space-y-4">
              ...
              <p>
                • <strong>Year‑End Discipline</strong> —{" "}
                <a href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/details/cgcb" target="_blank" rel="noopener noreferrer" className="underline">CGCB</a>,{" "}
                <a href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/details/cgcp" target="_blank" rel="noopener noreferrer" className="underline">CGCP</a>,{" "}
                <a href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/details/cgmu" target="_blank" rel="noopener noreferrer" className="underline">CGMU</a>{" "}
                historically pay little‑to‑no cap‑gain distributions.
              </p>
          ...
          <Card className="shadow-xl rounded-2xl">
            <CardContent className="p-6 md:p-8 space-y-4">
              ...
              <p>
                • <strong>Flexible Cash Management</strong> — park idle cash in{" "}
                <a href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/details/cgmu" target="_blank" rel="noopener noreferrer" className="underline">CGMU</a>, redeploy at will.
              </p>
          ...
          <Card className="shadow-xl rounded-2xl">
            <CardContent className="p-6 md:p-8 space-y-4">
              <h3 className="text-2xl font-semibold text-indigo-700">Research‑Driven Security Selection</h3>
      ...
      <section className="py-20 px-4 md:px-12 bg-indigo-600 text-white text-center">
        ...
        >
          ...
          map the role of{" "}
          <a href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/details/cgcb" target="_blank" rel="noopener noreferrer" className="underline font-semibold">CGCB</a>,{" "}
          <a href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/details/cgcp" target="_blank" rel="noopener noreferrer" className="underline font-semibold">CGCP</a>{" "}
          and{" "}
          <a href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/details/cgmu" target="_blank" rel="noopener noreferrer" className="underline font-semibold">CGMU</a>{" "}
        ...
        <motion.div
          ...
          className="mt-10"
        >
          <Link href="https://www.capitalgroup.com/advisor/investments/exchange-traded-funds/active-fixed-income-etfs.html#resources" target="_blank">
            <Button
              size="lg"
              variant="secondary"
